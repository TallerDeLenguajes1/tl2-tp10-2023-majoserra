...
namespace EspacioRepositorios
{
    public interface ITareaRepository
    {
        ...
        public void UpdateTareaAsignada(int idUsuario); // cambie el usuario a 0 a todas las tareas que me asignaron 
        public Tarea GetById(int id);//Obtener detalles de una tarea por su ID. (devuelve un objeto Tarea)
        public List<Tarea> GetTareaAsignadas(int idUsuario);/*Listar todas las tareas asignadas a un usuario específico.(recibe un idUsuario,devuelve un list de tareas)*/
        ...
        public void RemoveTareaTablero(int idTablero); // eliminar tareas segun el tablero 
